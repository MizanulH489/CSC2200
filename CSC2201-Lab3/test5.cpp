...
int  main()
{
    ...
    int testLength;        // length data item for forward/backward F/B functions
#endif
    ...
    do
    {
        ...
        case 'F': case 'f':                       // forward movement
            testList.moveForwardN(testLength);
            break;

        case 'B': case 'b':                       // forward movement
            testList.moveBackwardN(testLength);
            break;
...
#endif
        << " : In-lab Ex. 3)" << endl;
    cout << "  Fx  : Move forward x number of nodes" << endl;
    cout << "  Bx  : Move backward x number of nodes" << endl;
